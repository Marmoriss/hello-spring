...
public class TodoController {
	...
	public String insertTodo(Todo todo, RedirectAttributes redirectAttr) {
		...
		redirectAttr.addFlashAttribute("msg", "할 일이 추가되었습니다.");
