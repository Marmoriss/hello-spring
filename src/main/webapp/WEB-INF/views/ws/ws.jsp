...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	...
	// sockjs는 WebSocket 미지원 브라우져에 대해서도 양방향 통신을 가능하게 함.
	// 내부적으로 xhr-polling 등을 사용해 양방향 통신을 흉내냄
	
	// sockjs 버전
	const ws = new SockJS(`http://\${location.host}${pageContext.request.contextPath}/echo`); // http -> ws 101
