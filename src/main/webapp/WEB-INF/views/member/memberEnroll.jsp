	...
	<form name="memberEnrollFrm" action="" method="POST">
		<table class="mx-auto">
			...
			<tr>
				<th>휴대폰</th>
				<td>	
					<input type="tel" class="form-control" placeholder="(-없이)01012345678" name="phone" id="phone" maxlength="11" value="01000000000" required>
				</td>
			</tr>
			<tr>
				<th>주소</th>
				<td>	
					<input type="text" class="form-control" placeholder="" name="address" id="address" value="경기도" >
				</td>
			</tr>
			<tr>
				<th>성별 </th>
