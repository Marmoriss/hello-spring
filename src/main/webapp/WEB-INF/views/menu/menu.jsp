...
<div id="menu-container" class="text-center">
	...
	<script>
	/*
		Access to XMLHttpRequest at 'http://localhost:10000/springboot/menu' from origin 'http://localhost:9090' has been blocked by CORS policy: 
		...
		SOP Same Origin Policy 동일 근원 정책
			비동기요청은 동일한 근원으로만 가능하다.
		
		CORS policy
			Cross Origin Resource Sharing policy 타근원 자원 공유 정책
			응답헤어 Access-Control-Allow-Origin 헤더 값에 현재 Origin이 명시되어 있어야 함.
